...
SELECT feed_follows.id, created_at, feed_follows.updated_at, feed_follows.user_id, feed_id, feeds.id, name, feeds.updated_at, url, feeds.user_id, last_fetched_at 
    FROM feed_follows 
    LEFT JOIN feeds
    ON feeds.id = feed_id
